...
public class UseTestNgAnnotationTest {
    @BeforeSuite
    ...
    @Test(groups = {"perftest", "first-group"}, dataProvider = "testDataTime", priority = 1, threadPoolSize = 2, invocationCount = 1, timeOut = 10000)
